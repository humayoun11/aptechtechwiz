...
$getpendingusers= mysqli_query($connectiondb,$query);
...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
    <?php while($row= mysqli_fetch_assoc($getpendingusers)){?>
    ...
    <tr>
      ...
      <td><button class="btn btn-primary" name="accept"><a href="pendinguserapproved.php?acceptId=<?php echo $row["user_id"]?>" class="text-light"> Accept </a></button></td>
      <td><button class="btn btn-danger" name="reject"><a href="pendinguserdelete.php?acceptId=<?php echo $row["user_id"]?>"class="text-light"> Reject </a></button></td>
