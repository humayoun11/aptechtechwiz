...
<body>
    ...
    ***********************************-->
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" name="reject"><a href="userdelete.php?acceptId=<?php echo $row["user_id"]?> "class="text-light"> Reject </a></button></td>
      
      <td><button class="btn btn-primary" name="accept"><a href="stsupdateform.php?acceptId=<?php echo $row["user_id"]?> "class="text-light"> Accept </a></button></td>
