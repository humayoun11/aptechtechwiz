...
$query = 'select * from users_approved';
$getapprovedusers= mysqli_query($connectiondb,$query);
...
<body>
    ...
    ***********************************-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
    <?php while($row= mysqli_fetch_assoc($getapprovedusers)){?>
    ...
    <tr>
      ...
      <td><button class="btn btn-danger" name="reject"><a href="userdelete.php?acceptId=<?php echo $row["user_id"]?> "class="text-light"> Suspend </a></button></td>
      
      <!-- <td><button class="btn btn-primary" name="reject"><a href="stsupdateform.php?acceptId=<?php echo $row["user_id"]?> "class="text-light"> Update </a></button></td> -->
