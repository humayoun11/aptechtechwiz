      ...
      <div class="container-fluid">
          ...
          <div class="col-12">
            <div class="alazea-portfolio-filter">
              <div class="portfolio-filter">
                ...
                <button class="btn" data-filter=".office-design">
                  Office Design
                </button>
              </div>
            </div>
        ...
        <div class="row alazea-portfolio">
          ...
          >
            ...
            <div
              class="portfolio-thumbnail bg-img"
              style="background-image: url(img/bg-img/18.jpg)"
            ></div>
            <!-- Portfolio Hover Text -->
            <div class="portfolio-hover-overlay">
              <a
                ...
                <div class="row align-items-center">
                  ...
                  <div class="col-12 col-md-6">
                    <div class="testimonial-content">
                      ...
                      <p>
                        “Alazea is a pleasure to work with. Their ideas are
                        creative, they came up with imaginative solutions to
                        some tricky issues, their landscaping and planting
                        contacts are equally excellent we have a beautiful but
                        also manageable garden as a result. Thank you!”
                      </p>
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="single-blog-post mb-100">
              ...
              <div class="post-content">
                ...
                <div class="post-meta">
                  <a href="#"
                    ><i class="fa fa-clock-o" aria-hidden="true"></i> 20 Jun
                    2018</a
                  >
                  <a href="#"
                    ><i class="fa fa-user" aria-hidden="true"></i> Alan
                    Jackson</a
                  >
                </div>
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="single-blog-post mb-100">
              ...
              <div class="post-content">
                <a href="single-post.html" class="post-title">
                  <h5>
                    2018 Midwest Tree and Shrub Conference: Resilient Plants for
                    a Lasting Landscape
                  </h5>
                </a>
                <div class="post-meta">
                  ...
                  >
                  <a href="#"
                    ><i class="fa fa-user" aria-hidden="true"></i> Christina
                    Aguilera</a
                  >
                </div>
                <p class="post-excerpt">
          ...
          <div class="col-12 col-md-6 col-lg-4">
            <div class="single-blog-post mb-100">
              ...
              <div class="post-content">
                ...
                <div class="post-meta">
                  <a href="#"
                    ><i class="fa fa-clock-o" aria-hidden="true"></i> 19 Jun
                    2018</a
                  >
                  <a href="#"
                    ><i class="fa fa-user" aria-hidden="true"></i> Mason
                    Jenkins</a
                  >
                </div>
                <p class="post-excerpt">
